...
class FwdCNN_VAE(torch.nn.Module, FwdBase):
    ...
    def __init__(
        ...
        assert (
            state_predictor is None
        ), "FwdCNN_VAE doesn't use state predictor"
    ...
    def load_from_file(cls, file_path):
        ...
        if type(loaded) is dict:
            ...
            res = cls(
                layers=loaded["hyper_parameters"]["model"]["layers"],
                nfeature=loaded["hyper_parameters"]["model"]["nfeature"],
                dropout=loaded["hyper_parameters"]["model"]["dropout"],
                h_height=loaded["hyper_parameters"]["model"]["h_height"],
                h_width=loaded["hyper_parameters"]["model"]["h_width"],
                height=loaded["hyper_parameters"]["model"]["height"],
                width=loaded["hyper_parameters"]["model"]["width"],
                n_actions=loaded["hyper_parameters"]["model"]["n_actions"],
                hidden_size=loaded["hyper_parameters"]["model"]["hidden_size"],
                ncond=loaded["hyper_parameters"]["model"]["ncond"],
                nz=loaded["hyper_parameters"]["model"]["nz"],
                enable_kld=True,
                enable_latent=True,
                predict_state=True,
            )
            ...
            # This means that the class itself was dumped to a file.
            return loaded
